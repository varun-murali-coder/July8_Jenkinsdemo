...
//        e.g https://github.com/varun-murali-coder/July8_Jenkinsdemo.git might become https://github.com/MyName/external.git
// variables:
//      roidtc-july2022-u216
...
//      https://github.com/varun-murali-coder/July8_Jenkinsdemo.git
//      vcoderlearn
//      internal
//      cluster-1 
...
pipeline {
   ...
   environment {
        ...
        imageName = 'vcoderlearn/internal'
        dockerImage = ''
        }
    stages {
        stage('Run the tests') {
            ...
            steps {
                ...
                git branch: 'master',
                    url: 'https://github.com/varun-murali-coder/July8_Jenkinsdemo.git'
        ...
        stage('Building image') {
         ...
         stage('get k8s credentials') {
            ...
            steps {
                ...
                sh 'gcloud container clusters get-credentials cluster-1 --zone us-central1-c --project roidtc-july2022-u216'
            }
        }     
         stage('update k8s') {
             agent {
